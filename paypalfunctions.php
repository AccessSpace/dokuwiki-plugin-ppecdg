...
if(!defined('DOKU_INC')) die();
	...
	/*
	might want to take account of these
	  $aConf['proxy'] => 
  array (
    'host' => '',
    'port' => '',
	...
	*/
	...
	$SandboxFlag = $oHelper->getConf("sandbox")?true:false;
	//' TODO:
	//'------------------------------------
	...
	//'------------------------------------
	$API_UserName  = $oHelper->getConf("api_username");#"<API_USERNAME>";
	$API_Password  = $oHelper->getConf("api_password");#"<API_PASSWORD>";
	$API_Signature = $oHelper->getConf("api_signature");#"<API_SIGNATURE>";
